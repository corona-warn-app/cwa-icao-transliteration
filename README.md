...
Simple transliteration of non-latin letters into latin. (a-zA-Z)

## Description

This is a JS/TS implementation of some helper functions.

- normalize any string into a useful format
- transliteration of special latin, cyrillic and arabic letters.
...
$ git clone https://github.com/corona-warn-app/cwa-icao-transliteration.git

# Go into the repository
$ cd cwa-icao-transliteration
```
